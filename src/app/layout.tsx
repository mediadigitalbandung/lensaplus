...
export const metadata: Metadata = {
  ...
  title: {
    default: "Lensaplus — Media Berita Digital Nasional Indonesia",
    template: "%s | Lensaplus",
  },
  description:
    "Portal media berita digital nasional Indonesia — menyajikan informasi terkini seputar politik nasional, hukum & peradilan, bisnis-ekonomi, pemerintahan, olahraga, teknologi, dan peristiwa Nusantara tepercaya.",
  keywords: [
    "berita nasional",
