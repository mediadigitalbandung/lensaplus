          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
            ...
            <article className="lg:col-span-2">
              ...
              <div className="print-header hidden">
                ...
                <div>
                  <div className="print-title">Lensaplus</div>
                  <div className="print-subtitle">Media Berita Digital Bandung — lensaplus.com</div>
                </div>
              </div>
              ...
              {article.featuredImage && (
                <div className="group relative">
                  ...
                  {(() => {
                    ...
                    // says "Lensaplus" (our own site): recover the real
                    // publisher from the upstream source URL's domain.
                    const looksWrong =
                      !displayCredit ||
                      displayCredit.toLowerCase().includes("lensaplus");
                    if (article.isAutoGenerated && looksWrong) {
                      ...
                      displayCredit =
                        ...
                        (sourceName &&
                        !sourceName.toLowerCase().includes("lensaplus")
                          ? sourceName
                          : null) ||
              ...
              <div className="print-footer hidden">
                &copy; {new Date().getFullYear()} Lensaplus — lensaplus.com
