 ...
 * with sharp + an SVG overlay: photo, QR verification code, LENSAPLUS branding,
...
function isAllowedHost(rawUrl: string): boolean {
  try {
    ...
    return ALLOWED_IMG_HOSTS.has(h) || h.endsWith(".lensaplus.com");
  } catch {
    return false;
  }
}
...
/** Lensaplus's Dewan Pers verification number (matches the site footer). */
...
const DEFAULT_LOGO = "/lensaplus-icon.png";
...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="180" y="58" font-family="'Newsreader','Georgia',serif" font-size="40" font-weight="800" fill="#ffffff" letter-spacing="1">LENSAPLUS</text>
  ...
  <text x="${SIG_X2}" y="${H - 34}" font-family="'Work Sans','Helvetica',sans-serif" font-size="14" fill="#5d6066">Direktur Lensaplus</text>
...
const CARD_TERMS = [
  "Kartu ini merupakan identitas resmi pemegangnya sebagai anggota pers (jurnalis) Lensaplus.",
...
const RETURN_EMAIL = "admin@lensaplus.com";
...
export async function renderMembershipCardBack(input: CardRenderInput): Promise<Buffer> {
  ...
  const siteHost = (() => {
    try { return new URL(SITE).hostname.replace(/^www\./, ""); } catch { return "lensaplus.com"; }
  })();
...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="${logo ? 160 : PAD}" y="52" font-family="'Newsreader','Georgia',serif" font-size="34" font-weight="800" fill="#ffffff" letter-spacing="1">LENSAPLUS</text>
  ...
  <text x="${W - PAD}" y="${H - 126}" text-anchor="end" font-family="'Work Sans','Helvetica',sans-serif" font-size="15" fill="#5d6066">Jika ditemukan, mohon kembalikan ke Redaksi Lensaplus:</text>
...
<svg xmlns="http://www.w3.org/2000/svg" width="${LW}" height="${LH}" viewBox="0 0 ${LW} ${LH}">
  ...
  <text x="${cx}" y="190" text-anchor="middle" font-family="'Newsreader','Georgia',serif" font-size="32" font-weight="800" fill="#ffffff" letter-spacing="1">LENSAPLUS</text>
...
<svg xmlns="http://www.w3.org/2000/svg" width="${LW}" height="${LH}" viewBox="0 0 ${LW} ${LH}">
  ...
  <text x="${logo ? 122 : 36}" y="92" font-family="'Newsreader','Georgia',serif" font-size="28" font-weight="800" fill="#ffffff" letter-spacing="1">LENSAPLUS</text>
  ...
  <text x="36" y="${y + 40}" font-family="'Work Sans','Helvetica',sans-serif" font-size="14" fill="#5d6066">Jika ditemukan, kembalikan ke Redaksi Lensaplus:</text>
