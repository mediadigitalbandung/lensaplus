...
const LOGO = `<img src="/lensaplus-icon.png" alt="Lensaplus" style="width:40px;height:40px;object-fit:contain;border-radius:10px">`;
...
"Lensaplus — Pasang Iklan Header": `<div style="width:100%;aspect-ratio:728/120;max-height:160px;background:linear-gradient(135deg,#001530 0%,#002045 40%,#1a3a5c 70%,#002045 100%);border-radius:12px;display:flex;align-items:center;justify-content:space-between;padding:16px clamp(16px,4vw,40px);font-family:'Segoe UI',system-ui,sans-serif;overflow:hidden;position:relative;gap:16px">
  <style>
...
"Lensaplus — Banner Promo": `<div style="width:100%;aspect-ratio:728/100;max-height:140px;background:linear-gradient(135deg,#001530 0%,#002045 40%,#1a3a5c 70%,#002045 100%);border-radius:12px;display:flex;align-items:center;justify-content:space-between;padding:16px clamp(16px,4vw,40px);font-family:'Segoe UI',system-ui,sans-serif;overflow:hidden;position:relative;gap:16px">
...
"Lensaplus — Inline Promo": `<div style="width:100%;aspect-ratio:728/100;max-height:140px;background:linear-gradient(135deg,#001530 0%,#002045 50%,#1a3a5c 100%);border-radius:12px;display:flex;align-items:center;justify-content:space-between;padding:16px clamp(16px,4vw,40px);font-family:'Segoe UI',system-ui,sans-serif;overflow:hidden;position:relative;gap:16px">
...
// ═══ FOOTER (fixed ratio) ═══
"Lensaplus — Footer CTA": `<div style="width:100%;aspect-ratio:728/120;max-height:160px;background:linear-gradient(135deg,#001530 0%,#002045 30%,#1a3a5c 60%,#371800 100%);border-radius:12px;display:flex;align-items:center;justify-content:space-between;padding:16px clamp(16px,4vw,40px);font-family:'Segoe UI',system-ui,sans-serif;overflow:hidden;position:relative;gap:16px">
  ...
  <div style="display:flex;align-items:center;gap:clamp(10px,2vw,20px);z-index:1;min-width:0;flex:1">
    ...
    <div style="min-width:0">
      <div style="color:#d4364d;font-size:9px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;margin-bottom:3px">Lensaplus</div>
      <div style="font-size:clamp(13px,2.5vw,22px);font-weight:800;line-height:1.15;letter-spacing:-0.3px;background:linear-gradient(90deg,#fff 0%,#fff 30%,#e8edf3 48%,#d4364d 52%,#fff 70%,#fff 100%);background-size:300% auto;-webkit-background-clip:text;background-clip:text;color:transparent;animation:fc2Shine 5s linear infinite">Jadikan Lensaplus Sumber Berita Utama</div>
...
"Lensaplus — Floating Bar": `<div style="width:100%;height:48px;background:linear-gradient(135deg,#001530,#002045);display:flex;align-items:center;justify-content:center;gap:clamp(10px,2vw,20px);padding:0 16px;font-family:'Segoe UI',system-ui,sans-serif;position:relative">
  <div style="position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(90deg,#b7102a,#d4364d,#1a3a5c,#b7102a);background-size:200% 100%;animation:adLine 4s linear infinite"></div>
  <div style="display:flex;align-items:center;gap:8px;z-index:1">
    ...
    <span style="color:#fff;font-size:clamp(11px,1.2vw,13px);font-weight:600">Baca berita terbaru dari <strong>Lensaplus</strong></span>
  </div>
